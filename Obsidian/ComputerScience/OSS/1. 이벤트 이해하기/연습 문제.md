...
```
---
![[Pasted image 20240927103748.png]]
```html
<script>
i.onmousedown = large;
i.onmouseup = back;
...
```
---
![[Pasted image 20240927104308.png]]
- linear가 있으면 등속
- linear가 없으면 천천히 시작해서 빠르게 움지이다가 다시 천천히 움직인다
---
![[Pasted image 20240927105903.png]]
```html
<div id="sky" onmousemove = "updateImage(event)">
```
---
![[Pasted image 20240927110408.png]]
```js
i.style.transform = "translate(" + X + "px, " + Y + "px)";
```
---
![[Pasted image 20240927110822.png]]
```js
...
---
![[Pasted image 20240927111327.png]]

---
![[Pasted image 20240927112615.png]]
