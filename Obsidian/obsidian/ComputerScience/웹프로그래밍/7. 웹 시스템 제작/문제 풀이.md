...
```html
<li><a href="https://maps.app.goo.gl/tjQtwj5zTF3tDSDB8" target="map">찾아오시는 길</a>

<iframe name="map" src="https://www.daum.net"></iframe>
</body>
```

	<iframe> 태그 안에 name="map" 주고 targat="