...
updated: 2026-09-10
---
# 04. BoW와 TF-IDF — 문서 벡터화, 이진·빈도 단어가방 모델과 두 가지 TF-IDF 계산법
...
**TF 계산** (p.9~10) — 문서3은 7단어이므로 두 번 나온 `친구`는 $2/7 \approx 0.29$, 나머지는 $1/7 \approx 0.14$.
...
**③ TF × IDF** (p.15) — 문서1은 `[1.9163, 0, 0, 1.9163, 0, 0, 0, 0, 0, 0, 1.2231, 0, 0]`.
